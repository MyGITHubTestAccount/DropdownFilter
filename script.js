define(
	[ 	// Note: If you load .js files, omit the file extension, otherwise
    	...
    	function ($, properties, cssBootstrap, jsBootstrap, cssBootstrapSelect, jsBootstrapSelect, qlik) { 
			...
			var buildSelect = function(reply, command){
				...
				var $selectTagOptions = 'multiple data-size="auto" data-live-search="false" data-style="btn-inverse">';
        	...
        	return {
		            ...
		            paint: function ( $element, layout ) {
						...
						buildDropdown('Alpha' ,0 ,0 ,maxListEntries ,1 ,'create');
		           	} //end rendering logic
        	}; //end extension
